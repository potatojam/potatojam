...
var Progress = {
    ...
    addProgress : function (canvas) {
        ...
        canvas.insertAdjacentHTML('afterend', '<div id="' + Progress.progress_id + '" class="canvas-app-progress" style="width: 100%;"><div id="' + Progress.bar_id + '" class="canvas-app-progress-bar" style="width: 0%;">0%</div></div>');
    ...
    **/
    runApp: function(app_canvas_id, extra_params) {
        ...
        if (typeof params["splash_image"] !== 'undefined') {
            ...
            Module.canvas.style.backgroundSize = "contain"
        }
